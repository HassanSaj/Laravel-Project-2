<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="<?php echo e(route('create')); ?>" class="btn btn-primary float-lg-right">Add Car</a>
            </div>
        </div>
            ...
            <table class="table table-striped">
                ...
                <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('edit',$car->id)); ?>" type="button" class="btn btn-warning">Edit</a>
                            <a href="<?php echo e(route('delete',$car->id)); ?>" type="button" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/haroon/Desktop/workplace/carcrud/resources/views/home.blade.php ENDPATH**/ ?>